...
function maternal_vaccine() 
    ...
    if p.vaccine_eff_scenaro == "sigmoidal" 
        ...
        eff_hosp = [0.805, 0.733, 0.618, 0.466, 0.308, 0.180, 0.096, 0.048, 0.023, 0.010, 0.004, 0.000]
    ...
    elseif p.vaccine_eff_scenaro == "fixed" 
        ...
        eff_hosp = [0.677, 0.677, 0.677, 0.677, 0.701, 0.584, 0.467, 0.351, 0.234, 0.117, 0.000, 0.000]
